...
public class ForestScene extends Scene {
    ...
    public void init(Loader loader) {
        ...
        terrains.add(new Terrain(0, -1, loader, new ModelTexture(loader.loadTexture("textures/grass.png"))));
        terrains.add(new Terrain(-1, -1, loader, new ModelTexture(loader.loadTexture("textures/grass.png"))));
